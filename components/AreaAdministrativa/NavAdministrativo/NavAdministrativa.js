...
import styles from "./NavAdministrativa.module.css";
import Image from 'next/image';
import { useRouter } from 'next/router';
import { useState, useEffect, useRef } from 'react';
import MenuHamburger from "../../MenuHamburguer/MenuHaburguer";

export default function NavAdministrativa() {
    ...
    return (
        <div className={styles.container}>
            ...
            {isMenuOpen && (
                <div className={`${styles.mobile_menu} ${isFixed ? styles.fixed_menu : styles.relative_menu}`}>
                    ...
                    <nav className={styles.mobile_nav}>
                        <ul>
                            <li onClick={goToHome}><p>HOME ADMINISTRAÇAÕ</p></li>
                            <li><p>CONTEUDO</p></li>
                            <li><p>SOCIAL</p></li>
                            <li><p>NOVIDADES</p></li>
                        </ul>
            ...
            <div className={styles.container_ul}>
                <ul>
                    <li onClick={goToHome}><p>HOME ADMINISTRAÇÃO</p></li>
                    <li><p>SOCIAL</p></li>
                    <li><p>NOVIDADES</p></li>
                </ul>
            </div>
